...
public class FindGuitarTester {
  ...
  private static void initializeInventory(Inventory inventory) {
    ...
    inventory.addGuitar("1092", 12995.95,
            new GuitarSpec(Builder.RYAN, "SJ", Type.ACOUSTIC, 6,
                        Wood.INDIAN_ROSEWOOD, Wood.CEDAR));
    inventory.addGuitar("566-62", 8999.95,
            new GuitarSpec(Builder.RYAN, "Cathedral", Type.ACOUSTIC, 6,
                        Wood.COCOBOLO, Wood.CEDAR));
    inventory.addGuitar("6 29584", 2100.95,
            new GuitarSpec(Builder.PRS, "Dave Navarro Signature", Type.ELECTRIC, 6,
                        Wood.MAHOGANY, Wood.MAPLE));
  }
}
